...
export function summarizeFromUrl(url) {
...
export function summarize(title, content, callback, sentences_dict) {
...
export function getSortedSentencesEx(content, n, callback, sentences_dict) {
